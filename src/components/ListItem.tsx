...
export const ListItem = ({ id, canExpand, onExpanded, onCreateChild, isActive, isExpanded, docIcon, level = 0, label, onClick, icon: Icon }: ItemProps) => {
  ...
  return (
    <div
      ...
      className={cn(
        "flex group items-center gap-2 hover:bg-primary/5 cursor-pointer p-0.5 px-2.5 select-none font-medium text-muted-foreground group/item transition-all ease-in-out duration-300",
